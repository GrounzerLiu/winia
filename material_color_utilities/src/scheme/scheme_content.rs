...
pub fn scheme_content_with_contrast(
    ...
    DynamicScheme::new(
        ...
        TonalPalette::from_hct(fix_if_disliked(
            TemperatureCache::new(set_source_color_hct).get_analogous_colors_by_divisions(3, 6)[2],
        )),
        /*neutral_palette:*/
        TonalPalette::from_hue_and_chroma(
            set_source_color_hct.get_hue(),
...
pub fn scheme_content(set_source_color_hct: Hct, set_is_dark: bool) -> DynamicScheme {
    scheme_content_with_contrast(set_source_color_hct, set_is_dark, 0.0)
}
