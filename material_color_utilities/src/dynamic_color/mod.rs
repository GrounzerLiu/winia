...
mod dynamic_color_test {
    ...
    fn test() {
        ...
        assert_eq!(material_dynamic_colors::surface_dim().get_argb(&s), 0xffdcc0bc);
        ...
        assert_eq!(material_dynamic_colors::surface_container().get_argb(&s), 0xffffe2dd);
        assert_eq!(material_dynamic_colors::surface_container_high().get_argb(&s), 0xfff3d7d2);
        assert_eq!(material_dynamic_colors::surface_container_highest().get_argb(&s), 0xffe7cbc7);
        assert_eq!(material_dynamic_colors::on_surface().get_argb(&s), 0xff1b0e0b);
        assert_eq!(material_dynamic_colors::surface_variant().get_argb(&s), 0xfffddbd5);
        assert_eq!(material_dynamic_colors::on_surface_variant().get_argb(&s), 0xff46312e);
        ...
        assert_eq!(material_dynamic_colors::outline_variant().get_argb(&s), 0xff816763);
        ...
        assert_eq!(material_dynamic_colors::primary_container().get_argb(&s), 0xffdc0100);
        ...
        assert_eq!(material_dynamic_colors::secondary().get_argb(&s), 0xff522d19);
        assert_eq!(material_dynamic_colors::on_secondary().get_argb(&s), 0xffffffff);
        assert_eq!(material_dynamic_colors::secondary_container().get_argb(&s), 0xff91624b);
        ...
        assert_eq!(material_dynamic_colors::tertiary_container().get_argb(&s), 0xff946230);
        ...
        assert_eq!(material_dynamic_colors::error_container().get_argb(&s), 0xffcf2c27);
