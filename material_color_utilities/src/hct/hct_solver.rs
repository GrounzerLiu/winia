...
use crate::utils::{
    argb_from_linrgb, int_from_lstar, matrix_multiply, sanitize_degrees_double, signum, vec3,
    y_from_lstar, Argb, Vec3, K_PI,
};
...
fn midpoint(a: Vec3, b: Vec3) -> Vec3 {
    vec3((a.a + b.a) / 2.0, (a.b + b.b) / 2.0, (a.c + b.c) / 2.0)
}
